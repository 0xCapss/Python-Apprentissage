...
Notes sur le langage lui-meme (syntaxe, idiomes, pieges).
...
## Idiomes Python (pythonique)
- [ ] f-strings
- [ ] comprehensions de listes
- [ ] deballage (a, b = ...)

Notions deja vues en pratique :
- Indexation d'une liste : liste[0] est le premier element (les indices commencent a 0).
- Boucle for x in liste : passe sur chaque element.
